...
const expectedInstructions: Record<string, string> = {
  ...
  "bold|kiss|butt": "Küsse den Hintern.",
  ...
  "bold|bite|butt": "Beiße vorsichtig in den Hintern.",
  ...
  "bold|massage|butt": "Massiere den Hintern.",
  ...
  "bold|stroke|butt": "Streichle den Hintern langsam und aufmerksam.",
  ...
  "bold|surprise|butt": "Überrasche dein Gegenüber mit einer zärtlichen Idee für den Hintern.",
  ...
  "bold|rub|butt": "Reibe den Hintern langsam nach Absprache.",
  ...
  "bold|seduce|butt": "Verführe dein Gegenüber mit Fokus auf den Hintern.",
  ...
  "bold|smell|butt": "Rieche aufmerksam. Konzentration auf den Hintern.",
