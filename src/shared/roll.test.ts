...
const expectedInstructions: Record<string, string> = {
  ...
  "bold|surprise|anywhere":
    "Überrasche dein Gegenüber mit einer zärtlichen Idee für überall nach Absprache.",
  "bold|rub|neck": "Reibe erotisch an dem Nacken",
  "bold|rub|back": "Reibe erotisch an dem Rücken",
  "bold|rub|hands": "Reibe erotisch an den Händen",
  "bold|rub|legs": "Reibe erotisch an den Beinen",
  "bold|rub|thighs": "Reibe erotisch an den Schenkeln",
  "bold|rub|breasts": "Reibe erotisch an den Brüsten",
  "bold|rub|genitals": "Reibe erotisch an dem Geschlechtsteil",
  "bold|rub|nipple": "Reibe erotisch an dem Nippel",
  "bold|rub|butt": "Reibe erotisch an dem Po",
  "bold|rub|anywhere": "Reibe erotisch an überall nach Absprache",
