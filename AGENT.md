...
- Aufgaben-Platzhalter unterstuetzen {ort|akkusativ} und {ort|dativ}; {ort} bleibt Akkusativ. Zonen speichern deutsche Textformen nur noch unter text.de.accusative/text.de.dative; beide Felder sind im Zod-Schema Pflichtfelder, leere Dativfelder werden vor dem Speichern nach einer einfachen Pluralregel aus dem Akkusativ ergaenzt.
